...
#define SBK_PHONON_QLIST_QVARIANT_IDX                                5 // const QList<QVariant > &
#define SBK_PHONON_QSET_QOBJECTPTR_IDX                               6 // QSet<QObject * >
#define SBK_PHONON_QLIST_INT_IDX                                     7 // QList<int >
#define SBK_PHONON_QHASH_QBYTEARRAY_QVARIANT_IDX                     8 // QHash<QByteArray, QVariant >
#define SBK_PHONON_QLIST_PHONON_PATH_IDX                             9 // QList<Phonon::Path >
#define SBK_PHONON_QLIST_PHONON_EFFECTPARAMETER_IDX                  10 // QList<Phonon::EffectParameter >
#define SBK_PHONON_QPAIR_QBYTEARRAY_QSTRING_IDX                      11 // QPair<QByteArray, QString >
#define SBK_PHONON_QLIST_QPAIR_QBYTEARRAY_QSTRING_IDX                12 // QList<QPair<QByteArray, QString > >
...
#define SBK_PHONON_QLIST_QACTIONPTR_IDX                              15 // QList<QAction * >
#define SBK_PHONON_QLIST_PHONON_EFFECTPTR_IDX                        16 // QList<Phonon::Effect * >
#define SBK_PHONON_QLIST_PHONON_MEDIASOURCE_IDX                      17 // const QList<Phonon::MediaSource > &
#define SBK_PHONON_QLIST_QURL_IDX                                    18 // const QList<QUrl > &
#define SBK_PHONON_QMULTIMAP_QSTRING_QSTRING_IDX                     19 // QMultiMap<QString, QString >
#define SBK_PHONON_QLIST_PHONON_OBJECTDESCRIPTION_PHONON_EFFECTTYPE__IDX 20 // const QList<Phonon::ObjectDescription<Phonon::EffectType > > &
#define SBK_PHONON_QMAP_INT_QVARIANT_IDX                             21 // QMap<int, QVariant >
#define SBK_PHONON_QHASH_INT_QBYTEARRAY_IDX                          22 // const QHash<int, QByteArray > &
#define SBK_PHONON_QLIST_PHONON_OBJECTDESCRIPTION_PHONON_AUDIOOUTPUTDEVICETYPE__IDX 23 // const QList<Phonon::ObjectDescription<Phonon::AudioOutputDeviceType > > &
