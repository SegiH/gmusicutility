...
class ChangeSongMetadata(WcCall):
	...
	def _song_to_jsarray(song):
        ...
        attribs = ['name', 'albumArtUrl', 'artist', 'album', 'albumArtist',None, None, None, None, 'composer', 'genre', None, None,'track', 'totalTracks', 'disc', 'totalDiscs', 'year', None,None, None, None, 'rating', None, None, None, None,None, None, 'comment', None, None, None, None, None, None,None, 'explicitType', [], None, None, True]
    ...
    def dynamic_data(cls, songs, session_id=""):
        ...
        """
        #if any([s for s in songs if set(s.keys()) != set(['id','title','track','albumArtUrl'])]):
        #    raise ValueError("ChangeSongMetadata only supports the 'id' and 'albumArtUrl' keys." "All other keys must be removed.")
